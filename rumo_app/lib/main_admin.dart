...
import 'modules/backoffice/screens/backoffice_home_screen.dart';
import 'screens/login_screen.dart';

void main() {
  runApp(const RumoAdminApp());
}

class RumoAdminApp extends StatelessWidget {
  const RumoAdminApp({super.key});
...
class _AuthWrapperState extends State<_AuthWrapper> {
  ...
  bool get _isGestor {
    ...
    return u != null && (u.isGestorCentral || u.isGestorUnidade);
  }
  ...
  Widget build(BuildContext context) {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Use o app Rumo ou Rumo Parceiro para esta conta.',
    ...
    return const BackofficeHomeScreen();
  }
}
