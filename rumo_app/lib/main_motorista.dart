...
import 'modules/motorista/screens/motorista_home_screen.dart';
import 'screens/login_screen.dart';

void main() async {
  WidgetsFlutterBinding.ensureInitialized();
  await PushService().init();
  runApp(const RumoMotoristaApp());
}

class RumoMotoristaApp extends StatelessWidget {
  const RumoMotoristaApp({super.key});
...
class _AuthWrapperState extends State<_AuthWrapper> {
  ...
  Widget build(BuildContext context) {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Use o app Rumo ou Rumo Central para esta conta.',
    ...
    return const MotoristaHomeScreen();
  }
}
